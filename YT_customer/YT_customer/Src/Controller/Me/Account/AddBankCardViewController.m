...
@interface AddBankCardViewController ()<RGFieldViewDelegate,RGActionViewDelegate,UIScrollViewDelegate>
              ...
              errorMessage:(NSString*)errorMessage
{
    if (parserObject.success) {
        ...
        dispatch_after(popTime, dispatch_get_main_queue(), ^(void){
            ...
            if (self.addSucessBlock) {
                self.addSucessBlock(saveBank.bank);
            }
...
- (void)nextButtonClicked:(id)sender
{
    ...
    self.requestParas = @{@"bankNo" : self.cardNumberView.textFiled.text,
                          ...
                          loadingKey : @(YES)};
    self.requestURL = YC_Request_SaveBank;
}
