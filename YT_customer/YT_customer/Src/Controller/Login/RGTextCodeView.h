...
typedef void (^VerificationBlock)(NSString *mobile);

@interface RGTextCodeView : UIView<UITextFieldDelegate>

@property (strong, nonatomic) VerificationBlock verificationBlock;
