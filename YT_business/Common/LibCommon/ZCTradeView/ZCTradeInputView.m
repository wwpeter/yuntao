...
- (void)layoutSubviews
{
    ...
    /** 取消按钮 */
    self.cancleBtn.zc_width = ZCScreenWidth * 0.409375;
    self.cancleBtn.zc_height = ZCScreenWidth * 0.128125;
    self.cancleBtn.zc_x = ZCScreenWidth * 0.05;
    self.cancleBtn.zc_y = self.zc_height - (ZCScreenWidth * 0.05 + self.cancleBtn.zc_height);
    
    /** 确定按钮 */
    self.okBtn.zc_y = self.cancleBtn.zc_y;
    self.okBtn.zc_width = self.cancleBtn.zc_width;
    self.okBtn.zc_height = self.cancleBtn.zc_height;
    self.okBtn.zc_x = CGRectGetMaxX(self.cancleBtn.frame) + ZCScreenWidth * 0.025;
}
...
- (void)drawRect:(CGRect)rect
{
    ...
    // 画字
    NSString *title = self.inputTitle;
