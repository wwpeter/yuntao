...
{
    NSString *uaStr = [NSString stringWithFormat:@"appName/%@,appVersion/%@,systemName/%@,systemVersion/%@,deviceVersion/%@,width/%@,height/%@",@"YTBusiness",[ApplyUntil version],[self deviceSystemName],[self deviceSystemVersion],[self deviceVersion],@([[UIScreen mainScreen] currentMode].size.width),@([[UIScreen mainScreen] currentMode].size.height)];
    return uaStr;
}
