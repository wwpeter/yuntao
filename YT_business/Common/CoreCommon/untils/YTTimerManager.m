...
@interface YTTimerManager ()
@property (nonatomic, strong) NSMutableDictionary *timerContainer;
@property (nonatomic, strong) NSMutableDictionary *actionBlockCache;
@end

@implementation YTTimerManager
#pragma mark - Public Method

+ (YTTimerManager *)sharedInstance
{
    static YTTimerManager *_gcdTimerManager = nil;
    static dispatch_once_t onceToken;
    
    dispatch_once(&onceToken,^{
        _gcdTimerManager = [[YTTimerManager alloc] init];
    });
...
- (void)scheduledDispatchTimerWithName:(NSString *)timerName
                          ...
                          actionOption:(TimerActionOption)option
