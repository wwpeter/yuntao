...
{
     self.headImageView.image = [UIImage imageNamed:@"zhq_notify_list_icon"];
    self.mesLabel.text = notice.message;
    self.timeLabel.text = [YTTaskHandler outDateStrWithTimeStamp:notice.createdAt withStyle:@"yyyy-MM-dd hh:mm"];
