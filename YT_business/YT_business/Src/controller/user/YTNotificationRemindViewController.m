...
//        type = [[UIApplication sharedApplication] currentUserNotificationSettings].types;
        type = [[UIApplication sharedApplication] isRegisteredForRemoteNotifications];
    }
    else
    {
...
{
    if (!_hbImageView) {
        _hbImageView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"yt_business_logo_01.png"]];
    }
    return _hbImageView;
}
- (UILabel *)hbLabel
